...
Lad $X$ have udfaldsrum $\{x_1,x_2,\ldots\}$ og pmf $p_x$ og $g:\R\to \R$, så har vi
\begin{align*}
...
Lad $X$ være en diskret stokastisk variabel og $\mu = E[X]$. Så defineres \textbf{variansen} af $X$ som ved
\begin{align*}
    \Var[ X ] = E[(X-\mu)^2]
\end{align*}
vi definiere $\sigma = \sqrt{\Var[ X ]}$, som kaldes \textbf{standardafvigelsen} af $X$.
\end{defn}
